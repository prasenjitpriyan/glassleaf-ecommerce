...
import FallingLeaves from './(website)/(components)/falling-leaves';
import Footer from './(website)/(components)/footer';
import Navbar from './(website)/(components)/navbar';
import NotFoundAnimation from './(website)/(components)/not-found-animation';
        ...
        <main className="relative flex h-screen w-screen items-center justify-center overflow-hidden bg-background">
          ...
          <section
            ...
            <p className="mb-10 leading-relaxed text-foreground/80">
              You’ve wandered a little off the trail. The page you’re looking
              for may have withered away — or never existed.
            </p>
